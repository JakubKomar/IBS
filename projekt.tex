...
\projectinfo{
  ...
  title.cs={Technologie sítí 5G a jejich bezpečnost},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  ...
  % Abstrakt / Abstract
  abstract.cs={Práce se zaobírá technologií 5G a bezpečnostními machanizmy potřebných na její provoz.}, % abstrakt v českém či slovenském jazyce / abstract in czech or slovak language
